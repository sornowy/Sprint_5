...
class TestPersonlAccount():
    def test_open_personal_account_success(self, driver):
        ...
        email_remeber = driver.find_element(By.XPATH, ".//form/fieldset[1]/div/div/input").text
        ...
        email_personal_account = driver.find_element(By.XPATH, ".//div/ul/li[2]/div/div/input").text
